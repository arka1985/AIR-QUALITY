...
const Dashboard = () => {
    ...
    // Group data by station and enrich with strict priority logic
    const allStations = useMemo(() => {
        ...
        return stationList.map(station => {
            ...
            // Priority 3: No Data (Gray)
            // No derived data logic anymore.

            return {
                ...station,
                displayPM25: displayValue, // Keeping key name for compatibility
                hasRealTimeData,
                displayColor: getAQIColorHex(displayValue) // Will return gray if null
            };
        });
    }, [data]);
