            ...
            >
                ...
                {stations.map((station) => {
                    ...
                    const customIcon = L.divIcon({
                        ...
                        html: `<div class="marker-pin ${(!station.isDerived && station.displayPM25 !== null) ? 'marker-pulsating' : ''}" style="background-color: ${station.displayColor}; color: ${station.displayColor}; box-shadow: 0 0 5px ${station.displayColor};"></div>`,
                        iconSize: [12, 12],
                        iconAnchor: [6, 6]
                    });
