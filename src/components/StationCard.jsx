                            ...
                            >
                                ...
                                <Marker
                                    ...
                                    icon={L.divIcon({
                                        ...
                                        html: `<div class="marker-pin ${data.displayPM25 !== null ? 'marker-pulsating' : ''}" style="background-color: ${data.displayColor}; color: ${data.displayColor}; box-shadow: 0 0 5px ${data.displayColor};"></div>`,
                                        iconSize: [12, 12],
                                        iconAnchor: [6, 6]
                                    })}
                                />
